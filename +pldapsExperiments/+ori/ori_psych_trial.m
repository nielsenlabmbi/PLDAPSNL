function ori_psych_trial(p,state)
...
%this is where I will get the angle if .psych == 1
if p.trial.stimulus.psych == 1
    p.trial.stimulus.fullField = 0;
    if p.conditions{p.trial.pldaps.iTrial}.side==1
        %angle = 90;
        %p.trial.stimulus.angle = angle - p.conditions{p.trial.pldaps.iTrial}.angle*8;
        %closer to vertical
        angchoice = randi(2, 1);
        if angchoice == 1 %positive
            if p.conditions{p.trial.pldaps.iTrial}.angle == 6
                p.trial.stimulus.angle = 126;
            elseif p.conditions{p.trial.pldaps.iTrial}.angle == 7
                p.trial.stimulus.angle = 133;
            else
                angle = 90;
                p.trial.stimulus.angle = angle + p.conditions{p.trial.pldaps.iTrial}.angle*8;
            end
             ...
             if p.conditions{p.trial.pldaps.iTrial}.angle == 6
                p.trial.stimulus.angle = 54;
             elseif p.conditions{p.trial.pldaps.iTrial}.angle == 7
                p.trial.stimulus.angle = 47;
             else
                angle = 90;
                p.trial.stimulus.angle = angle - p.conditions{p.trial.pldaps.iTrial}.angle*8;
             end
        ...
        if angchoice == 1 %positive
             if p.conditions{p.trial.pldaps.iTrial}.angle == 6
                p.trial.stimulus.angle = 36;
             elseif p.conditions{p.trial.pldaps.iTrial}.angle == 7
                p.trial.stimulus.angle = 43;
             else
                angle = 0;
                p.trial.stimulus.angle = angle + p.conditions{p.trial.pldaps.iTrial}.angle*8;
             end
             ...
             if p.conditions{p.trial.pldaps.iTrial}.angle == 6
                p.trial.stimulus.angle = 144;
             elseif p.conditions{p.trial.pldaps.iTrial}.angle == 7
                p.trial.stimulus.angle = 137;
             else
                angle = 180;
                p.trial.stimulus.angle = angle - p.conditions{p.trial.pldaps.iTrial}.angle*8;
             end
