function p = drifting_setup3_1(p)
...
p.trial.pldaps.trialFunction='pldapsExperiments.drifting.drifting_trial3_1';
...
side(i).match=[0 180];
cond(i).direction = [0 180];
end
c{i} = generateCondList(cond(i),side(i),'pseudo',ceil(500/(length(cond(i).dotCoherence)*2)));
end
