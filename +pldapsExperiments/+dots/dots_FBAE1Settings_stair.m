function s = dots_FBAE1Settings_stair
% % turn saving off
% s.pldaps.nosave = 1;
...
s.stimulus.dotSpeed = 0.4;% speed in  deg/frame, multiple by 120 frames per second for deg/sec
s.stimulus.dotLifetime = 3;%s
s.stimulus.durStim = 60;
s.stimulus.frameRate = 120;
s.stimulus.direction = [0 180];
s.stimulus.stair= 1; %[0 1] if on space bar, 1 if ON
