function p = dots_setup3_coh_stair(p)
...
p.trial.pldaps.trialFunction='pldapsExperiments.dots.dotstrial3_coh_stair';
...
%% conditions:
cond.dotCoherence = p.defaultParameters.stimulus.dotCoherence(1);
...
side.par = 'direction';
cond.constant = p.defaultParameters.stimulus.constant;
cond.targetThreshold = p.defaultParameters.stimulus.targetThreshold;
