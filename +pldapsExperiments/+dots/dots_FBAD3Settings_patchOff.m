...
s.stimulus.dotCoherence =  0.9; %regulated by staircase, this is start value
...
s.stimulus.offset=[0 300 400 500 600]; %First setting is 0, increase to 3 with spacebar
