function p = dots_setup3_axis_stair(p)
...
p.trial.pldaps.trialFunction='pldapsExperiments.dots.dotstrial3_axis_stair';
...
cond(i).constant = p.defaultParameters.stimulus.constant;
cond(i).nEasyTrials = p.defaultParameters.stimulus.nEasyTrials;
cond(i).targetThreshold = p.defaultParameters.stimulus.targetThreshold;
cond(i).reference_rotation = p.defaultParameters.stimulus.reference_rotation;
