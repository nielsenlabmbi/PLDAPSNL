function p = runbm(p)
%runbm    run a new experiment for a previuously created pldaps class
% p = run(p)
%run biomotion. This is exactly the same as p = run(p) except this will
%delete the large dotpos file
