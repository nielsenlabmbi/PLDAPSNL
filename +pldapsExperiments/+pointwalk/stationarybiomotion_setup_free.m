function p = stationarybiomotion_setup_free(p)
...
p.trial.pldaps.trialFunction='pldapsExperiments.pointwalk.stationarybiomotion_trial_free';
...
%remeber in the earlier version, p.nrDots doesnt exist, it is speed
