function s = lesion_dots_settings_P7_FBAE7Vol
%measure psychometric functions for both sides using staircase
%space bar initiates new levels
...
%                      top = 0 bottom = 1080
s.stimulus.offset=10; %horizontal offset in deg (from point where stimulus turns on)
...
%s.stimulus.dotCoherence = [1 0.9 0.8 0.3 0.1];
