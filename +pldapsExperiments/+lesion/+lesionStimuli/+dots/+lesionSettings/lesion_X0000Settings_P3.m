function s = lesion_X0000Settings_P3
%This phase adjusts the stimulus size window from full speed to smaller
%window.
%FEMALE
%702781 = ANIMAL ID
...
s.stimulus.width=30; %deg %target value is 10deg
s.stimulus.delta_width = 10; %deg
