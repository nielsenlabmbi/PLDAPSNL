...
correct=0;
if p.conditions{p.trial.pldaps.iTrial}.plaid
    if activePort==p.trial.stimulus.port.LEFT || activePort == p.trial.stimulus.port.RIGHT || activePort == p.trial.stimulus.port.MIDDLE
        correct=1;
    end
else
switch p.trial.side
