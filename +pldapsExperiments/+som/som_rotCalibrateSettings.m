function s = som_rotCalibrateSettings
%040622 Thomas Burnett
%Adjusted version of FBAC2Settings with jitter of motor position and
%rotation set to 0 and mouseInput = ON
...
s.stimulus.orthrange=0; %noise range for position
s.stimulus.paraxis=1; %parallel axis
s.stimulus.parpos=1; %center of range
s.stimulus.parrange=0; %noise range for position
s.stimulus.rotaxis=3; %rotation axis
s.stimulus.rotrange=0; %noise range for rotation
s.stimulus.rotduring=15; %rotation angle during trial
