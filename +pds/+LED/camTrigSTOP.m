...
if p.trial.led.use==1
    ...
    wordvec=zeros(1,24);
    wordvec([p.trial.led.channel3, p.trial.led.channel4])=0; %it is ok only to update the channels we want to move - the other ones are masked out
    word=bi2de(wordvec);
